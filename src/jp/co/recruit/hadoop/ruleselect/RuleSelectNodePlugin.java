 ...
 * @author Krishna
 */
public class RuleSelectNodePlugin extends Plugin {
    // The shared instance.
    private static RuleSelectNodePlugin plugin;

    /**
     * The constructor.
     */
    public RuleSelectNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RuleSelectNodePlugin getDefault() {
        return plugin;
    }
